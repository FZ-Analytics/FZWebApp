...
//../img/pickup-front-view.png
    ...
    public String cbx(String name, String text, String img, int w, int h){
        String o = "";
...
<html>
    ...
    <%@include file="../appGlobal/bodyTop.jsp"%>
        <!--div id='dvTimeCont'-->
            ...
            <span style="font-size: 22pt"><b>AI-Driven Command-Center<b></span> 
            ...
            <div id="dvSetting" style="display:none;">
                ...
                <form action="aic/gpsView.jsp" method="get">
                    <%=cbx("cbHarvester", "Harvester","people2.png",30,50)%>
                    <%=cbx("cbTractor", "Tractor","red-tractor.svg",30,50)%>
                    <%=cbx("cbBinTruck", "Bin Truck","truck-green.png",30,50)%>
                    <%=cbx("cbMill", "Mill","factory-2.svg",30,50)%>
                    <%=cbx("cbCpoTruck", "CPO Truck","truck-yellow.png",30,50)%>
                    <%=cbx("cbPool", "Transport Pool","garage_open-512.png",30,50)%>
                    <%=cbx("cbCpoVessel", "CPO Vessel","ship.svg.png",30,50)%>
                    <%=cbx("cbBulking", "Bulking Station","oil_storage-512.png",30,50)%>
                    <%=cbx("cbSalesPerson", "Sales Person","salesperson.png",30,50)%>
                    <%=cbx("cbDeliveryTruck", "Delivery Truck","truck-yellow.png",30,50)%>
                    <%=cbx("cbRefinery", "Refinery","2000px-Factory_icon.svg.png",30,50)%>
                    <%=cbx("cbWarehouse", "Warehouse","warehouse.png",30,50)%>
                    <%=cbx("cbRetailCust", "Retail Customer","shop.jpg",30,50)%>
