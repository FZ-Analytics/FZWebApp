...
.containerxx {
  ...
  margin: 15px auto;
    ...
    <body>
        ...
        %>
        <%run(new com.fz.ffbv3.service.dashProd.dashProd01());%>
...
li a:hover {
    background-color: #111111;
            ...
            <ul>
                    <li><div class="containerxx" ><canvas id="r2mChart"></canvas></div></li>
                    <li><div class="containerxx" ><canvas id='r2wChart'></canvas></div></li>
                    <li><div class="containerxx" ><canvas id='r2dChart'></canvas></div></li>
            </ul>
        <script>
...
//restan
           ...
           s = <%=request.getAttribute("r2m")%>;
           var j = setColor(s);
           var ctx = document.getElementById('r2mChart').getContext('2d');
           var pmChart = new Chart(ctx, {
              type: 'bar',
              data: j,
              options : {
           ...
           s = <%=request.getAttribute("r2w")%>;
           var j = setColor(s);
           var ctx = document.getElementById('r2wChart').getContext('2d');
           var pmChart = new Chart(ctx, {
              type: 'bar',
              data: j,
              options : {
           ...
           s = <%=request.getAttribute("r2d")%>;
           var j = setColor(s);
           var ctx = document.getElementById('r2dChart').getContext('2d');
           var pmChart = new Chart(ctx, {
              type: 'bar',
              data: j,
              options : {
